...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/550988?api_key=1eb77d313bc4e4a52f8057187f85dbef';
    axios.get(url)
    .then (response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=1eb77d313bc4e4a52f8057187f85dbef&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=1eb77d313bc4e4a52f8057187f85dbef&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=3092058c`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
